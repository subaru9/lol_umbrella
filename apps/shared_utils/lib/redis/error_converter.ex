defmodule SharedUtils.Redis.Error do
  ...
  def to_error_message(%{__struct__: Redix.ConnectionError, reason: reason}) do
    ErrorMessage.internal_server_error("Redis connection error", %{reason: reason})
  end

  def to_error_message(%{__struct__: Redix.Error, message: message}) do
    ErrorMessage.internal_server_error("Redis command error", %{message: message})
  end

  def to_error_message(other) do
    ErrorMessage.internal_server_error("Unknown error", %{error: other})
  end
end
